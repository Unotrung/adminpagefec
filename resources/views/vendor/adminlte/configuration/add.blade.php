...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{route('configuration.index')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
            ...
            <form method="POST" action="{{route('configuration.store')}}" enctype="multipart/form-data" >
                ...
                <!-- <div class="form-group row"> -->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="string" class="form-control" name="status" placeholder="Title" >
                        </div>
                    </div>
                {{-- Save Button --}}
